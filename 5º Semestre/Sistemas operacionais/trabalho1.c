...
int conditionThread1 = 0;
int conditionThread2 = 0;

void *thread1(void *data){
     unsigned long i,j;
     //inicializar
     conditionThread1 = 1;
     //executar quando a variavel de condição for diferente de 0 na th2
     do{
